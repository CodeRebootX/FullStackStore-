...
class Logica  {
  static final List<User> listaRegistro = [
    User(nombre: "Rolando", pass: "Rolando", trato: "Sr.", edad: 36, imagen: "", lugarNacimiento: "Zaragoza", administrador: false),
    User(nombre: "admin", pass: "admin", trato: "Sr.", edad: 50, imagen: "", lugarNacimiento: "Zaragoza", administrador: true),
  ];
  ...
  static String? validarUser (String user1, String password) {
    try {
      User user = listaRegistro.firstWhere(
        (u) => u.nombre == user1 && u.pass == password
      );
